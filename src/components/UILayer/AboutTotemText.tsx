...
import { aboutTotem } from "constants/totems";
...
const AboutTotemText: React.FC<AboutTotemTextProps> = ({ playerX }) => {
  //Радиус Вынести в константу
  if (!checkIsElementsCollide(-playerX * playerSpeed, aboutTotem.xPos, 100)) return;
  ...
  return (
    <DialogContainer>
      <AboutTotemTextContainer>
        ...
        <p>I like video games (Probly you have already noticed), everything on this site drawn and coded by me..</p>
