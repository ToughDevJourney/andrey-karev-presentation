...
var Gif = (function () {
  Gif.getCanvasElement = function (selector) {
    ...
    if (
      ...
      ((ref = element = document.querySelector(selector)) != null
        ? ref.tagName
        : void 0) === "CANVAS"
    ) {
      return element;
...
var Animator = (function () {
  ...
  function Animator(_reader, _frames) {
    ...
    this._advanceFrame = this.bind(this._advanceFrame, this);
    this._nextFrameRender = this.bind(this._nextFrameRender, this);
    this._nextFrame = this.bind(this._nextFrame, this);
    ref = this._reader;
      ...
      this.onFrame = (function (_this) {
        return function (frame, i) {
          ...
          if (frame.buffer == null) {
            frame.buffer = Animator.createBufferCanvas(
              frame,
              _this.width,
              _this.height
            );
          ...
          return (ref = _this.onDrawFrame) != null
            ? ref.apply(_this, [ctx, frame, i])
            : void 0;
        };
      })(this);
    }
